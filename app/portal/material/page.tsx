        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-gray-50">
            {materials.map((m) => {
              ...
              const context = (m.lesson as { title: string } | null)?.title ?? (m.course as { title: string } | null)?.title ?? "";

              return (
                <div key={m.id} className="px-6 py-4 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                      ...
                      <span className="text-xs text-gray-400">{context} · {date}</span>
